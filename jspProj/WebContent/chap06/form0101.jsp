...
// request 객체에 들어있는 memId, password, remember-me name에 매핑된 value를 
// 화면에 출력해보자
...
<body>
	<div class="card" style="width: 18rem;">
		<div class="card-body">
			...
			<!-- 
			onsubmit : submit버튼 클릭 시 fn_check() 함수를 실행 후 submit
					   true가 리턴되면 submit. / false가 리턴되면 submit안됨
			 -->
				<form action="form0101_process.jsp" method="post"
					...
					<div class="mb-3">
						<label for="memId" class="form-label">아이디</label> <input
							...
							aria-describedby="idHelp" placeholder="아이디를 입력해주세요" required />
					</div>
					<div class="mb-3">
